  ...
  return (
    <div className='relative min-[320px]:hidden lg:block col-span-2 pt-6 h-[75vh] | 2xl:h-[90vh] select-none'>
        <div className='absolute 2xl:w-[107%] flex justify-between top-[50%] 2xl:pl-[14rem] lg:pl-4 lg:w-[97%]'>
            <BsFillArrowLeftCircleFill className='text-white/50 2xl:text-[40px] lg:text-[22px]'  onClick={rest}/>
            <BsFillArrowRightCircleFill className='text-white/50 2xl:text-[40px] lg:text-[22px]' onClick={add}/>
        </div>
